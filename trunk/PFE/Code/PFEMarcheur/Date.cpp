...
/*
  Cette fonction permet de convertir une chaine de caract�re donn�e
  en entier elle prend en param�tre la chaine source et le nombre de
  caract�re et renvoie l'entier equivalent
 */
